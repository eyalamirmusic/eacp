...
// Linear so a glyph drawn at a fractional position or a non-integer zoom
// resamples smoothly rather than shimmering. It belongs to the draw rather than
// to the atlas texture, because the shader is what decides how it samples - see
// GPU::TextureSampling.
constexpr auto glyphSampling = GPU::TextureSampling {GPU::TextureFilter::Linear,
