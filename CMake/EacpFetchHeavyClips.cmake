# The four demo clips that PlayingHeavyContent renders and Tests/Video
# decodes: Big Buck Bunny / Jellyfish / Sintel, ~25 MB of 1080p + 720p H.264
...
get_filename_component(EACP_HEAVY_CLIPS_DIR
        "${CMAKE_CURRENT_LIST_DIR}/../Apps/Video/PlayingHeavyContent/media"
        ABSOLUTE)

function(eacp_fetch_heavy_clips out_files)
    set(clips
    ...
    foreach (clip IN LISTS clips)
        ...
        set(file "${EACP_HEAVY_CLIPS_DIR}/${name}")
        ...
        if (NOT code EQUAL 0)
            ...
            file(REMOVE "${file}")
            message(FATAL_ERROR "eacp_fetch_heavy_clips: could not fetch ${name} "
