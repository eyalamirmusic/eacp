...
public:
    ...
    // What the last dispatch cost in the units this exists to cut: one dispatch
    // however many paths went in, and one buffer update per buffer that had
    // something in it rather than per path.
